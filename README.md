...
| Style | What it does |
| --- | --- |
| `STE100` | Makes Claude write all user-facing prose in [ASD-STE100 Simplified Technical English](https://en.wikipedia.org/wiki/Simplified_Technical_English): one fact per sentence, active voice, plain words, no idioms. Code, paths, and error messages stay verbatim. |

Pick it with `/output-style` after the plugin is enabled.
